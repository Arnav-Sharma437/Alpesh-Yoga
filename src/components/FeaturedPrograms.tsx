        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {COURSES.map((course) => (
            <a
              key={course.id}
              href={course.href}
              className="group relative block overflow-hidden rounded-[28px] bg-sand-50"
            >
              ...
              <div className="absolute bottom-0 left-0 flex w-full flex-col justify-end p-8">
                <p className="mb-2 font-sans text-sm font-medium uppercase tracking-wider text-white/80">
                  {course.location} · {course.duration}
                </p>
                <h3 className="mb-3 font-serif text-2xl font-normal tracking-wide text-white md:text-3xl">
                ...
                <p className="mb-4 font-serif text-xl text-white/90">From {course.priceLabel}</p>
                <div className="flex items-center gap-2 font-sans text-sm font-medium uppercase tracking-widest text-white/90">
